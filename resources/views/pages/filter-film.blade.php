...
<div class="full-width col-md-12">
    <div class="category" style="padding-top: 100px;">
        <h4 class="text-light category-name">Kết quả lọc phim</h4>
            <form action="{{route('locphim')}}" method="GET">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2" style="padding:5px 10px 10px 0px">
                        <div class="form-group">
                            {!! Form::selectYear('year_filter', 1995, 2025 , isset($_GET['year_filter']) ? $_GET['year_filter'] : '', ['class' => 'select-year form-control custom-input','placeholder'=>'Năm']) !!}
                        </div>
                    </div>
