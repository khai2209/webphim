    ...
    <div class="info-film row">
        <div class="content col-md-8 my-5" style="padding-top: 60px;">
            ...
            <div class="d-flex my-3">
                ...
                <a href="#" class="text-light me-2 fw-semibold d-flex align-items-center" style="padding: 8px 8px; background-color:#2D2F34; border-radius:5px">
                        ...
                        <li class="glide__slide">
                            <article class="item-container">
                                <div class="cover" onclick="redirectToFilm('{{ route('film-info', $related->slug) }}')" style="cursor:pointer">
                                    ...
                                    <span class="body-movie__ep d-block"><i>Tập 1/{{$related->episodes}}</i></span>
